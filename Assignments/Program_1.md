...
* @Description: 
*     This program displays coutries, recognizes mouse click and a thick border appers with rectangle
...
if __name__ == '__main__':
    ...
    df.add_polygons(['Spain','France','Belgium','Ireland', 'Scotland','Greece','Germany','Egypt','Morocco','India'])
